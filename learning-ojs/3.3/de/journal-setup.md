...
version: 3.3
showPageTOC: true
title: Open Journal Systems 3.3 lernen - Zeitschrifteneinstellungen
---
...
![OJS-Dashboard-Ansicht für Journal Manager mit Links zum Einstellungsmenü und dessen Untermenüs in der linken Seitenleiste.](./assets/learning-ojs3.1-jm-settings-journal.png)
...
![OJS-Dashboard-Ansicht der Journaleinstellungen mit Navigationstabs für die Untermenüs der Einstellungen über den oberen Teil des Seiteninhalts.](./assets/learning-ojs3.2-jm-settings-journal-page.png)
...
![OJS-Dashboard-Ansicht des Untermenüs Journaleinstellungen Kontakt, wo Informationen in Textfeldern hinzugefügt werden können.](./assets/learning-ojs3.2-jm-settings-journal-contact.png)
...
![Ansicht der Rubriken der Zeitschrift im OJS-Dashboard. Ein rotes Kontrollkästchen neben der Rubrik Artikel zeigt an, wo es inaktiv markiert werden soll.](./assets/learning-ojs3.3-section-setting-inactive.png)
...
![Neues Fenster, das die aktuellen Einstellungen eines Abschnitts anzeigt, die editierbar sind.](./assets/learning-ojs-3.2-settings-website-settings-sections-edit-1.png)
...
![Ein neues Fenster für die Eingabe von Rubrikinformationen in Textfeldern und die Auswahl von Rubrikeinstellungen.](./assets/learning-ojs-3.2-settings-website-settings-sections-create.png)
...
![Die Liste der Optionen zur Einschränkung einer Rubrik. Elemente können aus der Liste ausgewählt werden, indem Sie das Kästchen links neben dem Element markieren.](./assets/learning-ojs3.2-jm-settings-journal-sections-restrict.png)
...
![Eine Liste der verfügbaren Rubriken von oben bis unten auf der Seite im OJS-Dashboard.](./assets/learning-ojs3.2-jm-settings-journal-sections-order.png)
...
![Ein neues Fenster für die Eingabe von Kategorieinformationen in Textfeldern und die Auswahl von Kategorieeinstellungen.](./assets/learning-ojs3.1-create-category.png)
